      ...
      <Container className="space-y-10">
        ...
        <div className="grid gap-5 md:auto-rows-fr md:grid-cols-2">
          {benefits.map((benefit, index) => {
            ...
            return (
              <Reveal key={benefit.title} className="h-full" delay={index * 0.07}>
                <article className="group relative h-full min-h-[160px] overflow-hidden rounded-[28px] border border-white/[0.06] bg-[rgba(255,255,255,0.02)] p-6 backdrop-blur-[10px] transition-all duration-300 hover:border-[rgba(126,192,255,0.3)] hover:shadow-[0_24px_70px_-36px_rgba(78,161,255,0.35)]">
                  ...
                  <div className="relative flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-textMuted md:text-base">
                        {benefit.description}
                      </p>
                    </div>
                  </div>
