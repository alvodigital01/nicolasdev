      ...
      <Container className="relative grid gap-8 pb-10 sm:gap-10 sm:pb-14 lg:min-h-[calc(100svh-5.5rem)] lg:grid-cols-[0.94fr_0.9fr] lg:items-center xl:gap-12">
        <motion.div style={{ y }} className="relative space-y-5 sm:space-y-6 lg:pr-4 xl:space-y-7">
          ...
          <div className="space-y-4 text-center sm:space-y-4 sm:text-left xl:space-y-5">
            ...
            <motion.p
              className="mx-auto max-w-[34ch] text-[1.05rem] leading-relaxed text-textMuted sm:mx-0 sm:max-w-xl sm:text-[15px] md:text-lg"
          ...
          <motion.div
            className="flex flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:gap-4"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="hidden max-w-xl gap-3 sm:grid sm:grid-cols-3"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
