...
type DividerVariant = "hero" | "arc" | "ribbon" | "pulse" | "echo" | "horizon";
...
const dividerPaths: Record<DividerVariant, string> = {
  ...
  echo: "M20 42C118 42 156 58 260 58C386 58 434 20 560 20C646 20 694 52 780 52C900 52 952 28 1088 28C1136 28 1158 34 1180 40",
